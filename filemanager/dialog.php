            ...
            foreach ($files as $nu=>$file_array) {
                ...
                if(in_array($file_array['extension'], $config['ext_img'])){
                    ...
                    if($ftp){
                        ...
                        if($_SESSION["goruntuleme_klasor"] != "public"){

                            $src_thumb = $base_url."/storage-thumb/".$rfm_subfolder.$subdir.$file;
                            $full_image_url = $base_url."/storage/".$rfm_subfolder.$subdir.$file;
...
?>
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                ...
                <figcaption>
                    ...
                    <a class="tip-right preview" title="<?php echo trans('Preview')?>" data-featherlight="<?php echo $full_image_url;?>"  href="#"><i class=" icon-eye-open"></i></a>
