...
class fisViewModel extends Dimodel {
    /*
     * Controller::$userInfo
     */
    /*
   ...
   */
    ...
    public function getfis($fatura_id,$type)
    {
...
alim_evraklari.owner_id = ?";
    ...
    public function getfisKalemleri($fatura_id,$type)
    {
    ...
    public function ikitariheGorefislar($bas_tarih,$bit_tarih, $type){
...
and alim_evraklari.remove = 0  and alim_evraklari.owner_id = ? and alim_evraklari.evrak_tur = 3  
...
WHERE 
(satis_evraklari.tarih >= ? and satis_evraklari.tarih <= ?)  and satis_evraklari.evrak_tur = 3   
and satis_evraklari.remove = 0  and satis_evraklari.owner_id = ? ORDER BY satis_evraklari.id DESC";
    ...
    public function getSatisfislari(){
        $year = date("Y");
...
stok_haraket_cikis.owner_id = ?  and 
stok_haraket_cikis.remove = 0 and 
satis_evraklari.evrak_tur = 3 and   
...
";
    ...
    public function getAlimfislari(){
        $year = date("Y");
...
stok_haraket_giris.owner_id = ?  and 
stok_haraket_giris.remove = 0 and 
alim_evraklari.evrak_tur = 3 and   
